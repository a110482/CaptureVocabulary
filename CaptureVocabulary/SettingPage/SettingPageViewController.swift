...
private extension SettingPageViewController {
    ...
    func configTableView() {
        ...
        tableView.register(SettingReadingCell.self,
                           forCellReuseIdentifier: SettingReadingCell.type.reuseId)
        tableView.register(SettingSwitchSentenceCell.self,
                           forCellReuseIdentifier: SettingSwitchSentenceCell.type.reuseId)
        tableView.register(MoreSettingCell.self,
                           forCellReuseIdentifier: MoreSettingCell.type.reuseId)
        tableView.register(VersionNumberCell.self,
                           forCellReuseIdentifier: VersionNumberCell.type.reuseId)
...
extension SettingPageViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(
            withIdentifier: cellModel.type.reuseId) as? SettingPageCellProtocol else {
            assertionFailure()
